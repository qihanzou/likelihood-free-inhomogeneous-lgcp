# This is the code for creating the training and testing data to reproduce the NV22 paper.
# The code use the future.apply for parallel computing.
...
## Prepare training input for neural network
# L
