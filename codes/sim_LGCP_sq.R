...
beta1_train = runif(ntrain,  0, 1) 
beta2_train = runif(ntrain,  0, 1) 
...
Y_train_true = sqrt(train_par_true)
...
Y_train_1less = sqrt(train_par_1less)
...
Y_test_truemodel <- sqrt(test_par)
Y_test_1less <- sqrt(test_par)
...
source_python("C:/Users/qihan/Desktop/sim_LGCP/sim_LGCP_NN.py")
# +beta as input
# Scenario 1
pred_true_model_true_beta = NN_model_est(L_train_true, Y_train_true, 
                                            L_test_truelam_true, Y_test_truemodel, 
                                            beta_train_true, beta_true_test_true, 
                                            batch_size=100, epochs=20, lr=1e-3)
Y_pred_true_model_true_beta = t(t((pred_true_model_true_beta[[1]]^2)))

# Scenario 2
pred_true_model_est_beta = NN_model_est(L_train_true, Y_train_true, 
                                           L_test_estlam_true, Y_test_truemodel, 
                                           beta_train_true, beta_est_test_true, 
                                           batch_size=100, epochs=20, lr=1e-3)
Y_pred_true_model_est_beta = t(t((pred_true_model_est_beta[[1]]^2)))

# Scenario 3
pred_1less_model_est_beta = NN_model_est(L_train_1less, Y_train_1less, 
                                            L_test_estlam_1less, Y_test_1less, 
                                            beta_train_1less, beta_est_test_1less, 
                                            batch_size=100, epochs=20, lr=1e-3)
Y_pred_1less_model_est_beta = t(t((pred_1less_model_est_beta[[1]]^2)))
...
plot.res = 600
png("beta0_correct_model_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("beta1_correct_model_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("beta2_correct_model_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# mincon
plot.res = 600
png("mincon_var_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("mincon_scale_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# clik2
plot.res = 600
png("clik2_var_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("clik2_scale_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# palm
plot.res = 600
png("palm_var_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("palm_scale_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# adapcl
plot.res = 600
png("adapcl_var_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("adapcl_scale_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# case1
plot.res = 600
png("case1_var_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("case1_scale_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# case2
plot.res = 600
png("case2_var_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("case2_scale_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# case3
plot.res = 600
png("case3_var_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("case3_scale_sq.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
