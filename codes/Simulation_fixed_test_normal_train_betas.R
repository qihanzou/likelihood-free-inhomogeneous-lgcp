...
plot.res = 600
png("data_fixed_test_normal_train_betas_hist_estimated_beta0_test_density.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_hist_estimated_beta1_test_density.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_hist_simulated_beta0_train_density.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_hist_simulated_beta1_train_density.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
