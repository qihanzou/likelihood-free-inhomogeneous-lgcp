...
# Lobs_ppm <- Linhom(X1, lambda = lambda_ppm, r = r, correction = "border")
...
set.seed(2026)
plot.res = 600
png("app_envtest_dsbi_std.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
env_lgcp1(as.numeric(Y_pred_unscaled_M1), "DSBI (std)")
dev.off()
