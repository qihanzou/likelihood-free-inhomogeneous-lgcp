...
def NN_model_est_M1(L_train, Y_train, L_test, Y_test, N_train, N_test, batch_size=100, epochs=20, lr=1e-3):
    ...
    Y_test = np.array(Y_test, dtype=np.float64, copy=True, order="C")
    ...
    for j in range(epochs):
        ...
        validation = run_epoch(XL_test, XN_test, Y_test_t, train=False)
