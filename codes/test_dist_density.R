...
# Training:
# ------------------------------------------------------------------------------
plot(beta0, beta0_mincon, xlab = "True beta0", ylab = "Pred beta0", main = "beta0", xlim = c(4.9, 5.1), ylim = c(3, 7))
abline(h=5, col = "red")


plot(beta1, beta1_mincon, xlab = "True beta1", ylab = "Pred beta1", main = "beta1", xlim = c(0.9, 1.1), ylim = c(0, 2))
abline(h=1, col = "red") 
...
# mincon:
plot.res = 600
png("data_fixed_test_normal_train_betas_mincon_var.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_mincon_scale.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# clik2
plot.res = 600
png("data_fixed_test_normal_train_betas_clik2_var.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_clik2_scale.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# palm
plot.res = 600
png("data_fixed_test_normal_train_betas_palm_var.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_palm_scale.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
# adapcl
plot.res = 600
png("data_fixed_test_normal_train_betas_adapcl_var.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_adapcl_scale.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_DSBI_loss.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_M2_var.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_M2_scale.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_hist_estimated_beta0_test_density2.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
hist(beta0_mincon, probability = T, main = expression(paste("Histogram of estimated ",beta[0], " KPPM")), xlab = expression(paste("Estimated ",beta[0], " KPPM")), breaks = 20)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_hist_estimated_beta1_test_density2.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
hist(beta1_mincon, probability = T, main = expression(paste("Histogram of estimated ",beta[1], " KPPM")), xlab = expression(paste("Estimated ",beta[1], " KPPM")), breaks = 20)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_hist_simulated_beta0_train_density2.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
...
plot.res = 600
png("data_fixed_test_normal_train_betas_hist_simulated_beta1_train_density2.png", width = 6.2 * plot.res, height = 4.5 * plot.res, res = 600)
